 ...
 * </p>
 * <ul>
 *   <li>{@link edu.upb.lp.isc.losCheetos.impl.MyRacketProgramImpl#getDefines <em>Defines</em>}</li>
 *   <li>{@link edu.upb.lp.isc.losCheetos.impl.MyRacketProgramImpl#getExecutions <em>Executions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MyRacketProgramImpl extends MinimalEObjectImpl.Container implements MyRacketProgram
{
  ...
  {
    return LosCheetosPackage.Literals.MY_RACKET_PROGRAM;
  }
  ...
  public EList<Define> getDefines()
  {
    if (defines == null)
    {
      defines = new EObjectContainmentEList<Define>(Define.class, this, LosCheetosPackage.MY_RACKET_PROGRAM__DEFINES);
    }
    return defines;
  }
  ...
  public EList<Expression> getExecutions()
  {
    if (executions == null)
    {
      executions = new EObjectContainmentEList<Expression>(Expression.class, this, LosCheetosPackage.MY_RACKET_PROGRAM__EXECUTIONS);
    }
    return executions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LosCheetosPackage.MY_RACKET_PROGRAM__DEFINES:
        return ((InternalEList<?>)getDefines()).basicRemove(otherEnd, msgs);
      case LosCheetosPackage.MY_RACKET_PROGRAM__EXECUTIONS:
